    ...
    return (
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    {others?.map((e, i) => <tr class="relative bg-gray-900 text-white border border-white">
                        <th scope="row" class="px-6 py-4 text-white">
                            {i + 1}
                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-white whitespace-nowrap  flex items-center space-x-2">
